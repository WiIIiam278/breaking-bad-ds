...
const Script SCRIPTS[64] = {
    ...
    {GALE,
     6,
     {
      "Very good! This is the lab   ventilation valve.",
      ...
      "Now! Let's turn on the lab   ventilation!",
      "Give the valve a nice turn!",
     },
     {EMOTE_NONE,
      EMOTE_QUESTION,
      EMOTE_NONE,
    ...
    {GUS,
     8,
     {
      ...
      "Allow me to remind you of an old adage:",
    ...
    {GUS,
      ...
      "I apologize for putting such a burden upon you...",
